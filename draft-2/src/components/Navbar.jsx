  ...
  return (
    ...
    >
      <Link href="/" className="flex items-center gap-6 pointer-events-auto group">
        <div className="w-10 h-10 bg-gold rounded-lg flex items-center justify-center shadow-[0_0_20px_rgba(200,164,74,0.4)] group-hover:scale-110 transition-transform">
           <Hexagon className="text-black fill-black" size={20} />
        </div>
      ...
      <div className="hidden md:flex gap-16 items-center pointer-events-auto">
        ...
        <button className="w-12 h-12 rounded-full border border-white/10 flex flex-col items-center justify-center gap-1.5 cursor-none hover:bg-gold/10 transition-all group">
          <div className="w-6 h-[1px] bg-white group-hover:bg-gold transition-colors" />
          <div className="w-4 h-[1px] bg-white group-hover:bg-gold transition-colors" />
        </button>
      </div>
    </motion.nav>
  );
